...
const creators = [
  ...
  { name: "Impact Trading", subscribers: "50K", views: "250K", avatar: "https://cdn-images.dzcdn.net/images/talk/09fc40d297b6cf3f513d391d7ef0645b/0x1900-000000-80-0-0.jpg" },
  ...
  { name: "Kasper Trading", subscribers: "217K", views: null, avatar: "https://yt3.googleusercontent.com/Wr_ckZS6d34G5rmmvMGHjq8_LbtKEFQZapPgn1wh4xOzU3i2T9j76l9oL3596Ba3io79eqCZ=s900-c-k-c0x00ffffff-no-rj" },
          ...
          >
            {creators.map((creator, index) => (
              <motion.div
                ...
                className="glass rounded-2xl p-6 text-center hover:border-primary/50 transition-colors min-w-[250px] md:min-w-[280px] flex-shrink-0"
              >
                <img 
                  src={creator.avatar} 
                  alt={creator.name}
